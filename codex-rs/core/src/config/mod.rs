...
pub struct Config {
    ...
    /// When unset, compaction falls back to `model_max_output_tokens`.
    /// See `TurnContext::compact_max_output_tokens`.
    ...
    /// `model_reasoning_effort`. See `TurnContext::compact_reasoning_effort`.
...
impl Config {
    ...
    pub(crate) async fn load_config_with_layer_stack(
        ...
        let config = Self {
            ...
            compact_model_max_output_tokens: cfg.compact_model_max_output_tokens,
